...
export default function Home() {
	return (
		<div className="flex bg-gradient-to-b from-gray-50 to-[#d2d6db] p-4">
			<div className="flex flex-col bg-white rounded p-4 tablet:rounded-md">
				<div className="flex flex-col gap-7 self-stretch px-4 py-12 tablet:py-16 desktop:p-24">
					<div className="flex flex-col justify-center gap-5 self-stretch tablet:gap-16">
